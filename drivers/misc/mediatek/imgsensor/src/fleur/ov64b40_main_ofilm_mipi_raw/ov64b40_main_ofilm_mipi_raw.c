...
#include "ov64b40_main_ofilm_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40_MAIN_OFILM_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
#if MULTI_WRITE
#if 0 /*for debug*/
	LOG_INF("[ov64b40ofilm-debug]read back from sensor ++++++++++++++++++++++++++++++++++ len: %d start", len);
	for (i = 0; i < len/2; i++)
		LOG_INF("[ov64b40ofilm-debug]readback addr 0x%04x, 0x%02x,\n",
			para[2*i], read_cmos_sensor(para[2*i]) & 0xFF);
	LOG_INF("[ov64b40ofilm-debug]read back from sensor ++++++++++++++++++++++++++++++++++ len: %d end", len);
#endif
#endif
	return 0;
}
...
#define PDC_EEPROM_OFFSET_AAC   0x12E8  // [12-731]
#define PDC_EEPROM_OFFSET_OFILM   0x1E2C  // [12-731]
#define PDC_SENSOR_OFFSET   0x5F80

#define XTALK_EEPROM_OFFSET 0x296A//aac
...
static void read_cali_data_from_eeprom(void)
{
	...
	if (Is_Read_Otp_Data != 1) {
		...
		for (i = 0; i < PDC_SIZE; i++) {
			...
			pdc_cali_setting[2 * i + 1] = read_eeprom_sensor(PDC_EEPROM_OFFSET_AAC+i);
		}
...
static void sensor_init(void)
{
	...
	//mdelay(10);
	table_write_cmos_sensor(ov64b40ofilm_init_setting,
			sizeof(ov64b40ofilm_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_preview_setting,
		sizeof(ov64b40ofilm_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void normal_video_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_normal_video_setting,
		sizeof(ov64b40ofilm_normal_video_setting) / sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_hs_video_setting,
		sizeof(ov64b40ofilm_hs_video_setting) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_custom1_setting,
		sizeof(ov64b40ofilm_custom1_setting) / sizeof(kal_uint16));
}
...
static void custom2_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_custom2_setting,
			sizeof(ov64b40ofilm_custom2_setting) / sizeof(kal_uint16));
}
...
static void custom3_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_custom3_setting,
			sizeof(ov64b40ofilm_custom3_setting) / sizeof(kal_uint16));
}
...
static void custom4_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_custom4_setting,
			sizeof(ov64b40ofilm_custom4_setting) / sizeof(kal_uint16));
}
...
static void custom5_setting(void)
{
	...
	table_write_cmos_sensor(ov64b40ofilm_custom5_setting,
			sizeof(ov64b40ofilm_custom5_setting) / sizeof(kal_uint16));
}
...
static void custom6_setting(void)
{
	LOG_INF("E\n");
	preview_setting();
	//table_write_cmos_sensor(ov64b40ofilm_custom6_setting,
			//sizeof(ov64b40ofilm_custom6_setting) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("OV64B40OFILM get_imgsensor_id in\n");

	vendor_id = get_vendor_id();
	if (vendor_id != VENDOR_ID){
		LOG_INF("OV64B40OFILM get_vendor_id read is %x!", vendor_id);
...
UINT32 OV64B40_MAIN_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV64B40OFILM_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV64B40OFILM_MIPI_RAW_SensorInit	*/
